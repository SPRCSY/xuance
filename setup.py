...
setup(
    ...
    extras_require={
        ...
        "all": [
            ...
            "tensorflow==2.19.0",
            "tf_keras==2.19.0",
            "mindspore==2.6.0",  # mindspore might be installed manually.
            "protobuf==3.20.0",
        ],
        "tune": [
            "optuna>=4.1.0",
